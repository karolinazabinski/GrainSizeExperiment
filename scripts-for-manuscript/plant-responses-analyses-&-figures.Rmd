...
ab.sig.label1 <- expression("Pop, p = 0.00")
...
tot.Bio.sig.label1 <- expression("Pop, p = 0.00")
...
term.sig.label1 <- expression("Pop, p = 0.00")
...
longRt.sig.label2 <- expression("Sed, p = 0.00")
...
f1Size.sig.label1 <- expression("Pop, p = 0.00")
...
rhizLength.sig.label1 <- expression("Pop, p = 0.00")
...
sulfide.sig.label2 <- expression("Sed, p = 0.00")
